  ...
  return (
    <div>
      ...
      <p>
        ...
        relations entre elles, les postes de travail et les employés qui les occupent. Les Diagrammes Organisationnels
        sont utiles pour comprendre l'organisation interne d'une entreprise et la manière dont les ressources humaines
        ...
        Les Diagrammes Organisationnels sont utilisés pour documenter et communiquer la structure interne d'une
        organisation. Ils sont utiles pour les gestionnaires, les chefs d'entreprise, les consultants en gestion et
        d'autres parties prenantes pour comprendre comment les différentes parties de l'organisation fonctionnent
        ensemble. Ils peuvent également être utilisés pour faciliter la planification organisationnelle, la délégation
        des responsabilités, la prise de décision et la gestion des ressources humaines.
      </p>

      <img src="pfrrad1233613663300_00069_4-rad1232718330240_00003.image" alt="Merise" />
    </div>
  );
};

export default MeriseOrganisationnel;
