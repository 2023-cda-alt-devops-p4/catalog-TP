  ...
  return (
    <div>
      ...
      <p>
        ...
        d'Événements (DFE) :
        <li>
          - Acteurs Externes : Les acteurs externes sont des entités en dehors du système qui interagissent avec
          celui-ci. Ce sont généralement des utilisateurs, d'autres systèmes, des organisations, etc. Dans un DFE, les
          acteurs externes sont représentés par des symboles spécifiques tels que des icônes, et ils sont généralement
          placés à la périphérie du diagramme.
        </li>
        <li>
        ...
        <li>
          - Traitements : Les traitements ou processus représentent les activités ou les actions effectuées par le
          système en réponse aux événements. Chaque traitement est identifié par un numéro ou un nom et est généralement
        ...
        <li>
          - Actions : Les actions sont les résultats ou les effets produits par les traitements en réponse aux
          événements. Elles décrivent ce qui se passe après l'exécution d'un traitement donné.
        </li>
        <li>
