  ...
  return (
    <div>
      ...
      <p>
        ...
        <li>
          - Entités : Les entités représentent les objets, les concepts ou les entités du système d'information dont
          vous souhaitez modéliser le cycle de vie. Par exemple, dans un système de gestion de projets, les entités
          peuvent être des projets, des tâches, des employés, etc.
        </li>
        <li>
        ...
        <li>
          - Actions : Les actions représentent les activités ou les opérations qui sont effectuées à chaque étape du
          cycle de vie. Elles décrivent ce qui se passe lorsque l'entité est dans une étape particulière. Les actions
          peuvent être documentées à l'intérieur des rectangles représentant les étapes.
        </li>
        <li>
          - Conditions : Les conditions spécifient les circonstances ou les critères qui doivent être remplis pour
          qu'une transition ait lieu. Elles peuvent être utilisées pour modéliser des règles ou des décisions métier qui
          déterminent le passage d'une étape à une autre.
        </li>
        <li>
          - Durée : La durée représente le temps que prend une entité pour passer d'une étape à une autre. Cela peut
          être utile pour modéliser les délais ou les calendriers associés à chaque étape du cycle de vie.
        </li>
