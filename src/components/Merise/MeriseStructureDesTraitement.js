  ...
  return (
    <div>
      ...
      <p>
        ...
        <li>
          - Flux de Contrôle : Les flèches ou les lignes qui relient les processus et les sous-processus indiquent
          l'ordre dans lequel les tâches sont exécutées. Les flèches montrent la direction du flux de contrôle,
          c'est-à-dire l'ordre dans lequel les sous-processus sont exécutés.
        </li>
        <li>
          - Flux de Données : Les flux de données représentent les données qui sont transmises entre les processus et
          les sous-processus. Ils indiquent comment les informations circulent à l'intérieur du système et sont
          généralement représentés par des flèches avec des étiquettes pour identifier les données échangées.
        </li>
        <li>
          - Entrées et Sorties : Chaque processus ou sous-processus peut avoir des entrées (données requises pour
          exécuter la tâche) et des sorties (résultats produits par la tâche). Les entrées et les sorties sont
          généralement indiquées à l'extérieur des rectangles représentant les processus.
        </li>
        <li>
