  ...
  return (
    <div>
      ...
      <p>
        ...
        <li>
          Processus : Les processus, également appelés traitements, sont les principales actions ou opérations qui sont
          effectuées dans le système. Chaque processus est identifié par un numéro ou un nom unique. Dans un DST, chaque
          processus est représenté par un rectangle avec le numéro ou le nom du processus à l'intérieur.
        </li>
        <li>
