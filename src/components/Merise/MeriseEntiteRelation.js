  ...
  return (
    <div>
      ...
      <p>
        ...
        <li>
          Entités : Les entités représentent des objets du monde réel ou des concepts distincts dans le système que vous
          modélisez. Chaque entité est généralement représentée par un rectangle avec un nom. Par exemple, dans un
        ...
        <li>
          Cardinalités : Les cardinalités spécifient combien d'entités sont associées de chaque côté d'une relation. Les
          cardinalités sont généralement indiquées près des extrémités de la ligne de relation. Par exemple, une
