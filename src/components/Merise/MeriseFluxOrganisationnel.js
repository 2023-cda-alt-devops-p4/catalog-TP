    ...
    <div>
      ...
      <p>
        ...
        <li>
          ...
          éléments du système, y compris les entités externes, les processus, les bases de données et les fichiers.
          Chaque flux de données est identifié par un nom significatif, par exemple, "Commande", "Facture", "Client",
          etc. Les flux de données sont généralement représentés par des flèches avec une étiquette.
        </li>
        <li>
          Entités Externes : Les entités externes représentent les acteurs ou les systèmes externes au système en cours
          de modélisation, qui interagissent avec lui en fournissant ou en recevant des données. Les entités externes
          sont généralement représentées par des formes géométriques telles que des rectangles et sont étiquetées pour
          indiquer leur rôle, par exemple, "Client", "Fournisseur", "Système de paiement", etc.
        </li>
        <li>
        ...
        <li>
          Sous-Processus : Les sous-processus sont des processus plus détaillés qui décomposent les opérations en étapes
          spécifiques. Ils sont généralement représentés par des rectangles internes aux processus principaux. Les
          sous-processus peuvent également avoir leurs propres flux de données, entrées, sorties et règles de
          traitement.
        </li>
        <li>
          Relations : Les relations entre les entités externes, les processus, les sous-processus et les flux de données
          montrent comment ils sont connectés les uns aux autres. Les relations sont généralement illustrées par des
          lignes qui relient ces éléments. Elles indiquent comment les données sont échangées et traitées à un niveau
          plus détaillé.
        </li>
        <li>
