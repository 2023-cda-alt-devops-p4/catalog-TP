...
const DiagrammeDeClasses = () => (
  <div id="diagrammeClasses">
    <section className="diagrammeDeClasses">
      <h3>Diagramme de Classes</h3>
      <p>
        Les diagrammes de classes sont l'un des types de diagrammes UML les plus utiles, car ils décrivent clairement la
        structure d’un système particulier en modélisant ses classes, ses attributs, ses opérations et les relations
        entre ses objets.Ce diagramme fait partie de la partie statique d'UML, ne s'intéressant pas aux aspects
