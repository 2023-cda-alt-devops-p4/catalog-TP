  ...
  return (
    <div>
      ...
      <p>
        ...
        <li>
          Lignes de vie (lifelines) : Les lignes de vie sont des lignes verticales qui partent de chaque objet ou acteur
          et montrent la durée de vie de cet objet pendant la communication. Elles ressemblent à des barres verticales
          en pointillés ou en continu.
        </li>
        <li>
          Messages : Les messages dans un diagramme de communication représentent les communications entre les objets ou
          les acteurs. Ils sont généralement représentés par des flèches qui partent d'une ligne de vie et se dirigent
          vers une autre. Par exemple, un message "Envoyer Message" peut être envoyé du "Client Web" au "Serveur de
          Messagerie" pour envoyer un message.
        </li>
        <li>
        ...
        <li>
          Synchronisation : Vous pouvez utiliser des barres verticales pointillées pour montrer la synchronisation entre
          les objets, indiquant quand ils attendent une réponse avant de poursuivre.
        </li>
