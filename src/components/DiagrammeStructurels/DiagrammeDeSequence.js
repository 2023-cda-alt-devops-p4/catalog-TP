  ...
  return (
    <div>
      ...
      <p>
        ...
        produit en ligne.
        <li>
          - Objets ou acteurs : Les objets ou acteurs sont les participants du scénario. Dans notre exemple, nous
          aurions des objets tels que "Client", "Système de Commande", "Panier", "Base de Données", "Produit", et
          "Service de Paiement". Chaque objet est représenté par une ligne de vie verticale avec son nom en haut.
        </li>
        <li>
