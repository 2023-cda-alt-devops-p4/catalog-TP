  ...
  return (
    <div id="diagrammeDeTemps">
      ...
      <p>
        ...
        <li>
          - Transitions d'état : Vous pouvez utiliser des transitions d'état pour montrer comment les entités passent
          d'un état à un autre au fil du temps. Par exemple, un client peut passer de l'état "En attente de
          confirmation" à "Réservation confirmée" lorsque la compagnie aérienne accepte la réservation.
        </li>
        <li>
          - Conditions : Les conditions peuvent être utilisées pour montrer des conditions ou des événements
          déclencheurs qui provoquent un changement d'état ou une action à un moment donné.
        </li>
