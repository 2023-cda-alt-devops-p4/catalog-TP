  ...
  return (
    <div>
      ...
      <p>
        ...
        <li>
          - États : Les états sont les conditions ou les modes dans lesquels un objet ou un système peut se trouver.
          Dans notre exemple, nous aurions des états tels que "Éteint", "En attente", "En préparation du café", "Café
          prêt", "En nettoyage", etc. Chaque état est généralement représenté par un rectangle avec son nom à
          l'intérieur.
        </li>
        <li>
